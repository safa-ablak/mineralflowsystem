...
@AnalyzeClasses(packages = "be.kdg.prog6.invoicing", importOptions = ImportOption.DoNotIncludeTests.class)
class ArchitectureTest {
    private static final String DOMAIN_LAYER = "be.kdg.prog6.invoicing.domain..";
    private static final String ADAPTER_LAYER = "be.kdg.prog6.invoicing.adapter..";
    private static final String CORE_LAYER = "be.kdg.prog6.invoicing.core..";
    private static final String PORT_LAYER = "be.kdg.prog6.invoicing.port..";
    ...
    void givenApplicationClasses_thenNoLayerViolationsShouldExist() {
        final JavaClasses jc = new ClassFileImporter().importPackages("be.kdg.prog6.invoicing");
