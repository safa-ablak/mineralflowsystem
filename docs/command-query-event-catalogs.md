...
| **`DeliveryRecordedEvent`**                 | WarehouseActivityListener (landside)                                                                                           | Published when a delivery is recorded at a warehouse.                                                    |
| **`ShipmentRecordedEvent`**                 | WarehouseActivityListener (landside)                                                                                           | Published when a shipment is recorded at a warehouse.                                                    |
